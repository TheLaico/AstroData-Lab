...
class TipoPlaneta(BaseModel):
    ...
    Ejemplos: Terrestre, Gigante Gaseoso, Enana de Hielo, Supertierr.
...
class ObjetoAstronomico(BaseModel):
    ...
    heredencia de galaxias, sistemas, estrellas, planetas y lunas.
    """
...
# ============================================================================
# MODELOS DE CARACTERÍSTICAS Y EVALUACIÓN
# ============================================================================
...
class EvaluacionHabitabilidad(BaseModel):
    ...
    Utiliza un puntaje normalizado (0.0-1.0) donde 1.0 = máxima habitabilidad.
    Incluye timestamp para rastrear cuándo se realizó la evaluación.
    """
    id_eval_habitabilidad: int = Field(..., description="Identificador único de la evaluación")
    id_planeta: int = Field(..., description="Identificador del planeta evaluado")
    puntaje: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        description="Puntaje de habitabilidad normalizado entre 0.0 y 1.0"
    )
    descripcion: str = Field(..., description="Análisis detallado de los factores de habitabilidad")
    fecha: datetime = Field(..., description="Timestamp de cuándo se realizó la evaluación")
