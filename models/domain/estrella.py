...
astrafísicas y relación al sistema estelar.
"""

from pydantic import BaseModel, Field
from models.domain.base_objeto_astronomico import ObjetoAstronomico
...
class Estrella(ObjetoAstronomico):
    ...
    Extiende ObjetoAstronomico con características astrafísicas clave:
