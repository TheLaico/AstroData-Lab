...
class RepositorioConsultas:
    ...
    # ========================================================================
    # OPERACIONES DE EMBEDDINGS DE CONSULTA
    # ========================================================================
    ...
    async def guardar_embedding_consulta(
        ...
        """
        Guarda el embedding vectorial de una consulta.
        
        Inserta en tabla Embedding_Consulta el vector de embedding (384 dimensiones
        para MiniLM) para permitir búsqueda de similitud contra Embedding_Texto e
        Embedding_Imagen.
        ...
        Args:
            id_consulta: ID de la consulta cuyo embedding se guarda
            vector: Lista de flotantes del embedding (384 dimensiones)
        ...
        Example:
            >>> repo = RepositorioConsultas()
            >>> embedding_id = await repo.guardar_embedding_consulta(
            ...     id_consulta=42,
